...
order: 21
description: "Hexagram 21 噬嗑 as `100101`, GMS-valid, categories 变革与重构."
...
在当前的 Omega 文化映射计划里，第 21 卦 噬嗑 首先不是被当作抽象象义，而是被当作二元词 `100101` 来读取。该卦直接位于 `X_6` 内，因此不需要先经过 fold 才能进入稳定域。 它以三阳达到了 `No11` 允许的最大阳密度，因此是交替或近交替结构中的高密度稳定态。 它目前横跨的主题类别是 变革与重构，因此其 strongest reading corridor 集中在 fold-operator、fiber-structure、dynamical-systems 这些方向上。
